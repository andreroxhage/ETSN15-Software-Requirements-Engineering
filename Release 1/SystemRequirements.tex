...
The system should include features that improve customer satisfaction and loyalty, leading to 30\% of users comming back to visit the service at least once a month. The customer retention rates can be measured by user feedback and monitoring the flight search frequency by users.  
